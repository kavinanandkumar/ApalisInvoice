...
namespace ApalisInvoice_API.Common
{
    public class Cryptography
    {
        ...
        public static string GetExternalDocumentPath(string basePath, string DesignerName)
        {
            ...
            if (Directory.Exists(basePath))
            {
                ...
                {
                    rtnExternalPath = rtnExternalPath + "\\" + DesignerName;
                    if (!Directory.Exists(rtnExternalPath)) Directory.CreateDirectory(rtnExternalPath);
                }
            }
